...
// push a car at the top of stack(LLL)
// also have to consier the topIndex + 1
...
// pop off a card from the top of stack
...
// get the card from the top and copy the data
// into the argument
